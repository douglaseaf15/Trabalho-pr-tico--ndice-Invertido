...
${OBJECTDIR}/IsChars.o: IsChars.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IsChars.o IsChars.cpp
...
${TESTDIR}/tests/EntraPalavra.o: tests/EntraPalavra.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EntraPalavra.o tests/EntraPalavra.cpp


${TESTDIR}/tests/TestLerArquivo.o: tests/TestLerArquivo.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestLerArquivo.o tests/TestLerArquivo.cpp


${TESTDIR}/tests/TestArquivoQueContem.o: tests/TestArquivoQueContem.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestArquivoQueContem.o tests/TestArquivoQueContem.cpp
...
${OBJECTDIR}/Indice_nomain.o: ${OBJECTDIR}/Indice.o Indice.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Indice_nomain.o Indice.cpp;\
	else  \
...
${OBJECTDIR}/IsChars_nomain.o: ${OBJECTDIR}/IsChars.o IsChars.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IsChars_nomain.o IsChars.cpp;\
	else  \
